...
```sh
docker run -it --rm --name some-hstream-cli --network host hstreamdb/hstream:v0.14.0 hstream --port 6570 sql
```
...
[quick-start.yaml]: https://raw.githubusercontent.com/hstreamdb/docs/v0.14.0/assets/quick-start.yaml
